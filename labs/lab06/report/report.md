...
Как и в предыдущем случае при исполнении программы не получаю число 10. В данном случае выводится символ с кодом 10 (LF, \n в соответствии с таблицей ASCII )
...
![Название рисунка](image/6.014.png){#fig:014 width=70%}

Ввожу текст программы, котораы будет вычислять следующий пример: $$(5*2+3)/3$$ (рис. [-@fig:013]).

![Текст программы для вычисления примера](image/6.015.png){#fig:015 width=70%}

Создаю и запускаю исполняемый файл (рис. [-@fig:014]).

![Результат программы](image/6.016.png){#fig:016 width=70%}
...
![Изменённый текст программы](image/6.017.png){#fig:017 width=70%}

Создаю и запускаю исполняемый файл (рис. [-@fig:016]).

![Результат работы файла](image/6.018.png){#fig:018 width=70%}

Создаю новый файл variant.asm (рис. [-@fig:017]).

![Создание файла](image/6.019.png){#fig:019 width=70%}

Вожу текст программы, которая будет вычислять № варианта с помощью № студенческого билета (рис. [-@fig:018]).

![Текст программы для вычисления варианта](image/6.020.png){#fig:020 width=70%}

Создаю и запускаю исполняемый файл (рис. [-@fig:019]).

![Результат работы программы](image/6.021.png){#fig:021 width=70%}
...
- За вычисление варианта отвечают строки 34-37 (рис. [-@fig:019])
